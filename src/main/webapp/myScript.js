...
document.addEventListener("DOMContentLoaded", () => {
    // Get references to the weather icon element and weather condition value
    const weatherIcon = document.getElementById("weather-icon");
    const weatherCondition = document.getElementById("wc").value;

    // Mapping of weather conditions to their respective image URLs
    const weatherIcons = {
    ...
    weatherIcon.src = weatherIcons[weatherCondition] || "https://via.placeholder.com/100?text=No+Image";
});
